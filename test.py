...
class CustomTrainer(Trainer):
    ...
    def compute_loss(self, model, inputs, return_outputs=False):
        ...
        # pseudo_label
        mem_label = obtain_label(inputs, model, args)
...
def train_target(args):
    ...
    model = RobertaForSequenceClassification.from_pretrained('./models/train/roberta_model_rte', output_hidden_states=True).to(args.device)
    ...
    model.save_pretrained(f"./models/test/roberta_model_{args.dset}")
